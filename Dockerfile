...
RUN pip install --no-cache-dir "apache-airflow[otel]==${IMG_AIRFLOW_VERSION}"  --constraint "https://raw.githubusercontent.com/apache/airflow/constraints-${IMG_AIRFLOW_VERSION}/constraints-${IMG_PYTHON_VERSION}.txt"
 -r /requirements.txt
